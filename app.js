...
ReactDOM.render(<Ghostbusters />, document.getElementById(`root`));
//=====================
...
ReactDOM.render(<Tagline />, document.getElementById(`root`));
//======================
...
ReactDOM.render(<Janine />, document.getElementById(`root`));
//=====================
...
ReactDOM.render(<ToolsTalent />, document.getElementById(`root`));
//=====================
...
ReactDOM.render(<GhostbustersAll />, document.getElementById(`root`));
    ...
    render(){
        return (
            <div className="DiceContainer">
                <button className="RollDiceBtn" onclick={this.DiceClick}> <RollDice></RollDice></button>
                <p>Results Here: {this.state.DiceValue}</p>
            </div>
        )
    }
}
